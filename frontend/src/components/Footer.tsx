...
import npsfLogo from "@/assets/npsf-favicon.png";

const Footer = () => {
  return (
    <div className="container mx-auto px-3 md:px-4 max-w-6xl pb-3 md:pb-4">
      <footer className="w-full bg-navy text-white py-3 md:py-5 mt-auto border-t-2 border-nps-gold rounded-lg">
        <div className="px-3 md:px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 text-center md:text-left animate-fade-in pb-safe">
            <img src={npsfLogo} alt="Naval Postgraduate School Foundation Logo" className="h-8 md:h-12 w-auto flex-shrink-0" />
